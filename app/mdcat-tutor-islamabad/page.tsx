...
export default function MdcatTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="🏥"
      subjectOverview={[
        `The <a href="/tutors?subject=MDCAT&city=Islamabad" class="text-[#C43D24] hover:underline font-black">MDCAT tutor in Islamabad</a> market is highly competitive, with thousands of students vying for limited seats in medical and dental colleges across Pakistan. MDCAT (Medical & Dental College Admission Test) is the gateway to a medical career, and a high score is essential for admission to top institutions. Our verified MDCAT tutors in Islamabad provide expert guidance across all four subjects: <strong>Biology</strong>, <strong>Chemistry</strong>, <strong>Physics</strong>, and <strong>English</strong>.`,
        `Whether you need to master <a href="/tutors?subject=Biology&city=Islamabad" class="text-[#C43D24] hover:underline font-black">MDCAT Biology</a>, <a href="/tutors?subject=Chemistry&city=Islamabad" class="text-[#C43D24] hover:underline font-black">Chemistry</a>, <a href="/tutors?subject=Physics&city=Islamabad" class="text-[#C43D24] hover:underline font-black">Physics</a>, or <a href="/tutors?subject=English&city=Islamabad" class="text-[#C43D24] hover:underline font-black">English</a>, our experienced tutors provide targeted practice and comprehensive coverage of the entire syllabus. They are familiar with the latest <a href="/tutors?subject=MDCAT&exam=PMC" class="text-[#C43D24] hover:underline font-black">PMC</a> and <a href="/tutors?subject=MDCAT&exam=UHS" class="text-[#C43D24] hover:underline font-black">UHS</a> MDCAT patterns and provide strategies to help students achieve top percentiles.`,
      ...
      faqs={[
        ...
        {
          q: 'Do you offer online MDCAT tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition in Islamabad</a>, we also offer <a href="/tutors?subject=MDCAT" class="text-[#C43D24] hover:underline font-black">online MDCAT tutoring</a> for students who prefer the flexibility of learning from home. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which areas of Islamabad do your home tutors cover?',
