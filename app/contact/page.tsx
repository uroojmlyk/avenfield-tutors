        ...
        <section className="py-14 sm:py-16 px-4 sm:px-8 border-t border-[#E8C86A]/30 mt-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4 text-[#4a6a78] text-[0.9rem] leading-[1.8] font-semibold">
              <p>
                Reaching out to Avenfield Tutors is the first step toward finding a{' '}
                <Link href="/tutors" className="text-[#C43D24] hover:underline font-black">verified online or home tutor</Link>{' '}
                anywhere in Pakistan, the UAE, or the UK. Whether you already know you need an{' '}
                <Link href="/tutors?subject=O%20Level" className="text-[#C43D24] hover:underline font-black">O Level tutor</Link>,{' '}
                <Link href="/tutors?subject=IELTS" className="text-[#C43D24] hover:underline font-black">IELTS coach</Link>, or you're
                still figuring out which subject or level fits, a quick WhatsApp message is all it takes to get matched
                with the right educator.
              </p>
              <p>
                Parents in <Link href="/tutors?city=Lahore" className="text-[#C43D24] hover:underline font-black">Lahore</Link>,{' '}
                <Link href="/tutors?city=Karachi" className="text-[#C43D24] hover:underline font-black">Karachi</Link>, and{' '}
                <Link href="/tutors?city=Islamabad" className="text-[#C43D24] hover:underline font-black">Islamabad</Link> often
                reach out to compare home tuition against online options our team can walk you through both, explain our{' '}
                <Link href="/services" className="text-[#C43D24] hover:underline font-black">tutoring services</Link>, and
                recommend a verified tutor based on your child's exact requirements, at no cost.
              </p>
              <p>
                Educators interested in teaching can also get in touch here, or head straight to our{' '}
                <Link href="/become-tutor" className="text-[#C43D24] hover:underline font-black">become a tutor</Link> page to apply directly.
              </p>
            </div>
          </div>
        </section>
