...
export const metadata: Metadata = {
  // NOTE: no "| Avenfield Tutors" suffix here — app/layout.tsx already has
  // title.template: '%s | Avenfield Tutors', so it's appended automatically.
  // Old title was just "Become a Tutor – Apply Now" — generic, no keywords.
  // This one front-loads the search terms tutors actually type in.
  title: 'Become a Home Tutor Online & Home Tutoring Jobs in Pakistan',
  description:
    'Apply to become a verified tutor at Avenfield Tutors. Teach O Level, A Level, IELTS, MDCAT, CSS/PMS online or as a home tutor in Islamabad & Rawalpindi — connect with motivated students, no marketing needed.',
  keywords: [
    'become a tutor Pakistan', 'online tutoring jobs', 'home tutor jobs Islamabad',
    'home tutor jobs Rawalpindi', 'teach O Level', 'teach A Level',
    'tutor application', 'Avenfield Tutors apply',
  ],
  openGraph: {
    title: 'Become a Home Tutor — Online & Home Tutoring Jobs | Avenfield Tutors',
    description:
      'Share your knowledge and earn what you deserve. Apply to teach online or as a home tutor in Islamabad & Rawalpindi on Avenfield Tutors today.',
    type: 'website',
    locale: 'en_PK',
    siteName: 'Avenfield Tutors',
    url: `${SITE_URL}/become-tutor`,
  ...
  twitter: {
    card: 'summary_large_image',
    title: 'Become a Home Tutor | Avenfield Tutors',
    description: 'Apply to teach on Avenfield Tutors and connect with motivated students.',
  },
  alternates: {
    canonical: `${SITE_URL}/become-tutor`,
  },
