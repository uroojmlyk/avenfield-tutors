...
export default function UrduTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="📜"
      subjectOverview={[
        `The <a href="/tutors?subject=Urdu&city=Islamabad" class="text-[#C43D24] hover:underline font-black">Urdu tutor in Islamabad</a> market is active as students seek expert guidance in Pakistan's national language. Urdu is essential for academic success, cultural identity, and professional communication in Pakistan. Our verified Urdu tutors in Islamabad help students master everything from grammar and composition to literature and poetry with clarity and confidence.`,
        `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">O Level Urdu</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">A Level Urdu</a>, <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#C43D24] hover:underline font-black">IGCSE Urdu</a>, or <a href="/tutors?subject=FSc&city=Islamabad" class="text-[#C43D24] hover:underline font-black">FSc Urdu</a>, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus — from Cambridge CAIE and Edexcel to local Pakistani boards — and help students develop strong language and analytical skills.`,
