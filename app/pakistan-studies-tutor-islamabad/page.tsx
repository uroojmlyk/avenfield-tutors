...
// const url = `${SITE_URL}/pakistan-studies-tutor-islamabad`

// export const metadata: Metadata = {
//   title: 'Best Pakistan Studies Tutor in Islamabad | O Level, A Level & CSS Pakistan Studies',
//   description:
//     'Expert Pakistan Studies tutors in Islamabad for O Level, A Level, IGCSE & CSS. Learn Pakistan History, Geography, Pakistan Affairs & current issues. Free consultation.',
//   keywords: [
//     'Pakistan Studies tutor Islamabad',
//     'Pakistan Studies tuition Islamabad',
//     'Pakistan Studies teacher Islamabad',
//     'best Pakistan Studies tutor in Islamabad',
//     'Pakistan Studies home tutor Islamabad',
...
//     'IGCSE Pakistan Studies tutor',
//     'FSc Pakistan Studies tutor',
//     'Pakistan Studies teacher near me Islamabad',
//   ],
//   alternates: { canonical: url },
//   openGraph: {
//     title: 'Best Pakistan Studies Tutor in Islamabad | Avenfield Tutors',
//     description: 'Expert Pakistan Studies tutors in Islamabad for O Level, A Level, IGCSE & CSS. Learn Pakistan History, Geography & Pakistan Affairs. Free consultation.',
//     type: 'website',
//     locale: 'en_PK',
...
//     title: 'Best Pakistan Studies Tutor in Islamabad | Avenfield Tutors',
//     description: 'Expert Pakistan Studies tutors in Islamabad for O Level, A Level, IGCSE & CSS.',
//   },
//   robots: {
//     index: true,
//     follow: true,
...
// export default function PakistanStudiesTutorIslamabadPage() {
//   return (
//     <SubjectLandingPage
//       subject="Pakistan Studies"
//       city="Islamabad"
//       slug="pakistan-studies-tutor-islamabad"
//       pageTitle="Best Pakistan Studies Tutor in Islamabad | O Level, A Level & CSS Pakistan Studies"
//       pageDescription="Expert Pakistan Studies tutors in Islamabad for O Level, A Level, IGCSE & CSS. Learn Pakistan History, Geography, Pakistan Affairs & current issues. Free consultation."
//       metaKeywords={[
//         'Pakistan Studies tutor Islamabad',
//         'Pakistan Studies tuition Islamabad',
//         'Pakistan Studies teacher Islamabad',
...
//       subjectEmoji="📜"
//       subjectOverview={[
//         `The <a href="/tutors?subject=Pakistan%20Studies&city=Islamabad" class="text-[#E05C42] hover:underline font-black">Pakistan Studies tutor in Islamabad</a> market is essential for students seeking to understand Pakistans rich history, geography, and political development. Pakistan Studies is a core subject for O Level, A Level, and CSS aspirants, covering the nations journey from independence to the present day. Our verified Pakistan Studies tutors in Islamabad help students develop a deep understanding of Pakistans history, culture, and governance with clarity and insight.`,
//         `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#E05C42] hover:underline font-black">O Level Pakistan Studies</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#E05C42] hover:underline font-black">A Level Pakistan Studies</a>, <a href="/tutors?subject=CSS%20%2F%20PMS&city=Islamabad" class="text-[#E05C42] hover:underline font-black">CSS Pakistan Affairs</a>, or <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#E05C42] hover:underline font-black">IGCSE Pakistan Studies</a>, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus from Cambridge CAIE and Edexcel to local Pakistani boards and help students develop strong analytical and writing skills.`,
//         `With a focus on building conceptual understanding and exam technique, our <a href="/home-tutor-islamabad" class="text-[#E05C42] hover:underline font-black">home tutors in Islamabad</a> provide the undivided attention that Pakistan Studies requires. This personalised approach is particularly effective for students who need help with complex topics like the Pakistan Movement, constitutional development, and geopolitical analysis.`,
//       ]}
//       subjectDetails={[
//         `Our <strong class="text-[#2E4F5E]">Pakistan Studies tutors in Islamabad</strong> are subject matter experts with advanced degrees in History, Political Science, or Pakistan Studies. They have extensive experience teaching Pakistan Studies across multiple curricula <strong class="text-[#2E4F5E]">O Level</strong>, <strong class="text-[#2E4F5E]">A Level</strong>, <strong class="text-[#2E4F5E]">IGCSE</strong>, <strong class="text-[#2E4F5E]">FSc</strong>, and <strong class="text-[#2E4F5E]">CSS</strong> preparation. Their deep understanding of the subject enables them to explain complex historical and political concepts in simple, relatable terms.`,
...
//       ]}
//       whyChoose={[
//         'Our Pakistan Studies tutors in Islamabad are <strong>subject matter experts</strong> with advanced degrees in History, Political Science, or Pakistan Studies and proven track records of helping students achieve top grades.',
//         'We provide <strong>personalised lesson plans</strong> tailored to each student learning style, pace, and academic goals, ensuring efficient and effective learning of complex historical and political concepts.',
...
export default function PakistanStudiesTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="📜"
      subjectOverview={[
        `The <a href="/tutors?subject=Pakistan%20Studies&city=Islamabad" class="text-[#C43D24] hover:underline font-black">Pakistan Studies tutor in Islamabad</a> market is essential for students seeking to understand Pakistans rich history, geography, and political development. Pakistan Studies is a core subject for O Level, A Level, and CSS aspirants, covering the nations journey from independence to the present day. Our verified Pakistan Studies tutors in Islamabad help students develop a deep understanding of Pakistans history, culture, and governance with clarity and insight.`,
        `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">O Level Pakistan Studies</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">A Level Pakistan Studies</a>, <a href="/tutors?subject=CSS%20%2F%20PMS&city=Islamabad" class="text-[#C43D24] hover:underline font-black">CSS Pakistan Affairs</a>, or <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#C43D24] hover:underline font-black">IGCSE Pakistan Studies</a>, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus from Cambridge CAIE and Edexcel to local Pakistani boards and help students develop strong analytical and writing skills.`,
      ...
      faqs={[
        ...
        {
          q: 'Do you offer online Pakistan Studies tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition in Islamabad</a>, we also offer <a href="/tutors?subject=Pakistan%20Studies" class="text-[#C43D24] hover:underline font-black">online Pakistan Studies tutoring</a> for students who prefer the flexibility of learning from home. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which areas of Islamabad do your home tutors cover?',
