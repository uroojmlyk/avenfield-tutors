...
export default function CssTutorPakistanPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="📋"
      subjectOverview={[
        `The <a href="/tutors?subject=CSS%20%2F%20PMS&city=Pakistan" class="text-[#C43D24] hover:underline font-black">CSS tutor in Pakistan</a> market is crucial for aspirants seeking to join the country premier civil service. The Central Superior Services (CSS) exam is one of the most competitive examinations in Pakistan, requiring extensive preparation across compulsory and optional subjects. Our verified CSS tutors in Pakistan provide expert guidance to help candidates achieve their dream of joining the civil service.`,
        `Whether you need assistance with <a href="/tutors?subject=CSS%20Pakistan%20Affairs" class="text-[#C43D24] hover:underline font-black">Pakistan Affairs</a>, <a href="/tutors?subject=CSS%20Current%20Affairs" class="text-[#C43D24] hover:underline font-black">Current Affairs</a>, <a href="/tutors?subject=CSS%20English%20Essay" class="text-[#C43D24] hover:underline font-black">English Essay &amp; Precis</a>, or <a href="/tutors?subject=CSS%20Optional%20Subjects" class="text-[#C43D24] hover:underline font-black">optional subjects</a>, our experienced tutors provide personalised support tailored to the CSS syllabus. They understand the unique challenges of the CSS examination including the extensive syllabus, time management, and the need for critical analysis and effective writing skills.`,
      ...
      faqs={[
        ...
        {
          q: 'Do you offer online CSS tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition</a>, we also offer <a href="/tutors?subject=CSS%20%2F%20PMS" class="text-[#C43D24] hover:underline font-black">online CSS tutoring</a> for students who prefer the flexibility of learning from home or who are based outside major cities. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which cities in Pakistan do your home tutors cover?',
          a: 'Our CSS home tutors cover all major cities in Pakistan including Islamabad, Rawalpindi, Lahore, Karachi, Peshawar, Quetta, Faisalabad, Multan, Hyderabad, and many more. We also offer online CSS tutoring available worldwide. If you are in a city not listed, <a href="https://wa.me/923095154253" target="_blank" rel="noopener noreferrer" class="text-[#C43D24] hover:underline font-black">message us on WhatsApp</a> and we will confirm availability.',
        },
      ]}
      areas={PAKISTAN_AREAS}
      relatedSubjects={[
