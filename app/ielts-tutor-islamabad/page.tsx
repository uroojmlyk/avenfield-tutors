...
// // Islamabad Areas Data (same as previous)
...
export default function IeltsTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="🌍"
      subjectOverview={[
        `The <a href="/tutors?subject=IELTS&city=Islamabad" class="text-[#C43D24] hover:underline font-black">IELTS tutor in Islamabad</a> market is growing rapidly as more students and professionals seek to study, work, or migrate abroad. IELTS (International English Language Testing System) is a critical requirement for UK, Australian, Canadian, and New Zealand visa applications, as well as for university admissions in many English-speaking countries. Our verified IELTS tutors in Islamabad help students achieve their target band scores with focused, personalised preparation.`,
        `Whether you need to achieve <a href="/tutors?subject=IELTS&band=7" class="text-[#C43D24] hover:underline font-black">Band 7</a> or <a href="/tutors?subject=IELTS&band=8" class="text-[#C43D24] hover:underline font-black">Band 8+</a>, our experienced tutors provide targeted practice and feedback on all four modules: <strong>Speaking</strong>, <strong>Writing</strong>, <strong>Reading</strong>, and <strong>Listening</strong>. They understand the specific challenges faced by Pakistani students — particularly in <a href="/tutors?subject=IELTS&module=Writing" class="text-[#C43D24] hover:underline font-black">IELTS Writing Task 2</a> and <a href="/tutors?subject=IELTS&module=Speaking" class="text-[#C43D24] hover:underline font-black">IELTS Speaking Part 3</a> — and provide strategies to overcome them.`,
        `With a focus on building fluency, accuracy, and exam technique, our <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tutors in Islamabad</a> provide the undivided attention that IELTS preparation demands. This personalised approach helps students build confidence, identify their weaknesses, and make rapid progress toward their target band score.`,
      ]}
      subjectDetails={[
        `Our <strong class="text-[#2E4F5E]">IELTS tutors in Islamabad</strong> are highly experienced in preparing students for both <strong class="text-[#2E4F5E]">Academic</strong> and <strong class="text-[#2E4F5E]">General Training</strong> modules. They are familiar with the specific band descriptors and provide detailed feedback on practice tests to help students understand exactly what examiners are looking for.`,
        `We focus on <strong class="text-[#2E4F5E]">all four skills</strong> — Listening, Reading, Writing, and Speaking — with equal emphasis, while also providing targeted support in areas where students are weakest. Our tutors use official IELTS materials and past papers to give students an authentic test experience.`,
      ...
      faqs={[
        ...
        {
          q: 'Do you offer online IELTS tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition in Islamabad</a>, we also offer <a href="/tutors?subject=IELTS" class="text-[#C43D24] hover:underline font-black">online IELTS tutoring</a> for students who prefer the flexibility of learning from home. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which areas of Islamabad do your home tutors cover?',
