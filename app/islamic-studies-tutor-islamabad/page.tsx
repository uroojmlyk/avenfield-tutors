...
// const url = `${SITE_URL}/islamic-studies-tutor-islamabad`

// export const metadata: Metadata = {
//   title: 'Best Islamic Studies Tutor in Islamabad | O Level, A Level & Islamic History',
//   description:
//     'Find verified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE, FSc & University level. Expert tuition for Islamic History, Quranic Studies, Hadith & more. Free consultation.',
//   keywords: [
//     'Islamic Studies tutor Islamabad',
//     'Islamic Studies tuition Islamabad',
//     'Islamic Studies teacher Islamabad',
//     'best Islamic Studies tutor in Islamabad',
//     'Islamic Studies home tutor Islamabad',
...
//     'IGCSE Islamic Studies tutor',
//     'FSc Islamic Studies tutor',
//     'Islamic Studies teacher near me Islamabad',
//   ],
//   alternates: { canonical: url },
//   openGraph: {
//     title: 'Best Islamic Studies Tutor in Islamabad | Avenfield Tutors',
//     description: 'Verified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE, FSc & University level. Expert tuition for all topics. Free consultation available.',
//     type: 'website',
//     locale: 'en_PK',
...
//     title: 'Best Islamic Studies Tutor in Islamabad | Avenfield Tutors',
//     description: 'Verified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE, FSc & University level. Expert tuition for all topics.',
//   },
//   robots: {
//     index: true,
//     follow: true,
...
// export default function IslamicStudiesTutorIslamabadPage() {
//   return (
//     <SubjectLandingPage
//       subject="Islamic Studies"
//       city="Islamabad"
//       slug="islamic-studies-tutor-islamabad"
//       pageTitle="Best Islamic Studies Tutor in Islamabad | O Level, A Level & Islamic History"
//       pageDescription="Find verified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE, FSc & University level. Expert tuition for Islamic History, Quranic Studies, Hadith & more. Free consultation."
//       metaKeywords={[
//         'Islamic Studies tutor Islamabad',
//         'Islamic Studies tuition Islamabad',
//         'Islamic Studies teacher Islamabad',
...
//       subjectEmoji="🕌"
//       subjectOverview={[
//         `The <a href="/tutors?subject=Islamic%20Studies&city=Islamabad" class="text-[#E05C42] hover:underline font-black">Islamic Studies tutor in Islamabad</a> market is growing as students seek to deepen their understanding of Islam's rich history, theology, and civilization. Islamic Studies is a core subject for O Level, A Level, and university students, covering Quranic studies, Hadith, Islamic history, and contemporary issues. Our verified Islamic Studies tutors in Islamabad help students develop a comprehensive understanding of Islamic civilisation with academic rigour and spiritual insight.`,
//         `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#E05C42] hover:underline font-black">O Level Islamic Studies</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#E05C42} hover:underline font-black">A Level Islamic Studies</a>, <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#E05C42} hover:underline font-black">IGCSE</a>, or university-level courses, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus — from Cambridge CAIE and Edexcel to local Pakistani boards — and help students develop strong analytical and writing skills.`,
//         `With a focus on building conceptual understanding and exam technique, our <a href="/home-tutor-islamabad" class="text-[#E05C42} hover:underline font-black">home tutors in Islamabad</a> provide the undivided attention that Islamic Studies requires. This personalised approach is particularly effective for students who need help with complex topics like Islamic jurisprudence, the life of the Prophet (PBUH), and the history of the Islamic world.`,
//       ]}
//       subjectDetails={[
//         `Our <strong class="text-[#2E4F5E]">Islamic Studies tutors in Islamabad</strong> are subject matter experts with advanced degrees in Islamic Studies, Theology, or related fields. They have extensive experience teaching Islamic Studies across multiple curricula — <strong class="text-[#2E4F5E]">O Level</strong>, <strong class="text-[#2E4F5E]">A Level</strong>, <strong class="text-[#2E4F5E]">IGCSE</strong>, <strong class="text-[#2E4F5E]">FSc</strong>, and <strong class="text-[#2E4F5E]">University</strong> level courses. Their deep understanding of the subject enables them to explain complex theological and historical concepts in simple, relatable terms.`,
...
//         `We understand that Islamic Studies requires both academic rigour and spiritual sensitivity. That's why our tutors use <strong class="text-[#2E4F5E]">interactive teaching methods</strong> — including discussions, source analysis, and reflective exercises — to help students develop a balanced and informed understanding of Islam.`,
//       ]}
...
//       ]}
//       whyChoose={[
//         'Our Islamic Studies tutors in Islamabad are <strong>subject matter experts</strong> with advanced degrees in Islamic Studies, Theology, or related fields and proven track records of helping students achieve top grades.',
//         'We provide <strong>personalised lesson plans</strong> tailored to each student\'s learning style, pace, and academic goals, ensuring efficient and effective learning of complex Islamic concepts.',
...
export const metadata: Metadata = {
  title: 'Best Islamic Studies Tutor in Islamabad | O Level, A Level & Islamic History',
  description:
    'Qualified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE & University. Learn Quranic Studies, Hadith, Islamic History & Islamic Civilization. Free consultation.',
  keywords: [
    'Islamic Studies tutor Islamabad',
    'Islamic Studies tuition Islamabad',
    'Islamic Studies teacher Islamabad',
  ...
  openGraph: {
    title: 'Best Islamic Studies Tutor in Islamabad | Avenfield Tutors',
    description: 'Qualified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE & University. Learn Quranic Studies, Hadith & Islamic History. Free consultation.',
    type: 'website',
    locale: 'en_PK',
    siteName: 'Avenfield Tutors',
    url,
  ...
  twitter: {
    card: 'summary_large_image',
    title: 'Best Islamic Studies Tutor in Islamabad | Avenfield Tutors',
    description: 'Qualified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE & University.',
  },
  robots: {
    index: true,
    follow: true,
...
export default function IslamicStudiesTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      slug="islamic-studies-tutor-islamabad"
      pageTitle="Best Islamic Studies Tutor in Islamabad | O Level, A Level & Islamic History"
      pageDescription="Qualified Islamic Studies tutors in Islamabad for O Level, A Level, IGCSE & University. Learn Quranic Studies, Hadith, Islamic History & Islamic Civilization. Free consultation."
      metaKeywords={[
        'Islamic Studies tutor Islamabad',
        'Islamic Studies tuition Islamabad',
        'Islamic Studies teacher Islamabad',
      ...
      subjectEmoji="🕌"
      subjectOverview={[
        `The <a href="/tutors?subject=Islamic%20Studies&city=Islamabad" class="text-[#E05C42] hover:underline font-black">Islamic Studies tutor in Islamabad</a> market is growing as students seek to deepen their understanding of Islam rich history, theology, and civilization. Islamic Studies is a core subject for O Level, A Level, and university students, covering Quranic studies, Hadith, Islamic history, and contemporary issues. Our verified Islamic Studies tutors in Islamabad help students develop a comprehensive understanding of Islamic civilisation with academic rigour and spiritual insight.`,
        `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#E05C42] hover:underline font-black">O Level Islamic Studies</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#E05C42] hover:underline font-black">A Level Islamic Studies</a>, <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#E05C42] hover:underline font-black">IGCSE</a>, or university-level courses, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus from Cambridge CAIE and Edexcel to local Pakistani boards and help students develop strong analytical and writing skills.`,
        `With a focus on building conceptual understanding and exam technique, our <a href="/home-tutor-islamabad" class="text-[#E05C42] hover:underline font-black">home tutors in Islamabad</a> provide the undivided attention that Islamic Studies requires. This personalised approach is particularly effective for students who need help with complex topics like Islamic jurisprudence, the life of the Prophet (PBUH), and the history of the Islamic world.`,
      ]}
      subjectDetails={[
      ...
      whyChoose={[
        'Our Islamic Studies tutors in Islamabad are <strong>subject matter experts</strong> with advanced degrees in Islamic Studies, Theology, or related fields and proven track records of helping students achieve top grades.',
        'We provide <strong>personalised lesson plans</strong> tailored to each student learning style, pace, and academic goals, ensuring efficient and effective learning of complex Islamic concepts.',
        'Our tutors use <strong>interactive teaching methods</strong> including discussions, source analysis, and reflective exercises to make Islamic Studies engaging and academically rigorous.',
        'We offer <strong>flexible scheduling</strong> for both home tuition and online sessions, making it easy to fit Islamic Studies tutoring into your family busy schedule.',
      ]}
      faqs={[
        {
          q: 'What qualifications do your Islamic Studies tutors in Islamabad have?',
          a: 'All our Islamic Studies tutors hold at least a bachelor or master degree in Islamic Studies, Theology, or related fields, with many holding PhDs. They have extensive experience teaching Islamic Studies across multiple curricula including O Level, A Level, IGCSE, FSc, and University courses. Many tutors are also certified teachers or examiners with deep understanding of assessment criteria.',
        },
        {
          q: 'Which Islamic Studies curricula do you offer tuition for?',
