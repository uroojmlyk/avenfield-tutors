...
export default function PmsTutorPakistanPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="📜"
      subjectOverview={[
        `The <a href="/tutors?subject=CSS%20%2F%20PMS&city=Pakistan" class="text-[#C43D24] hover:underline font-black">PMS tutor in Pakistan</a> market is growing as aspirants seek to join provincial civil services through the Provincial Management Service (PMS) exam. The PMS exam is conducted by each province Public Service Commission (PPSC, SPSC, BPSC, KPKPSC) and offers a prestigious career in provincial administration. Our verified PMS tutors in Pakistan provide expert guidance to help candidates achieve their career goals.`,
        `Whether you need assistance with <a href="/tutors?subject=PMS%20Pakistan%20Affairs" class="text-[#C43D24] hover:underline font-black">Pakistan Affairs</a>, <a href="/tutors?subject=PMS%20Current%20Affairs" class="text-[#C43D24] hover:underline font-black">Current Affairs</a>, <a href="/tutors?subject=PMS%20English%20Essay" class="text-[#C43D24] hover:underline font-black">English Essay &amp; Precis</a>, or <a href="/tutors?subject=PMS%20Optional%20Subjects" class="text-[#C43D24] hover:underline font-black">optional subjects</a>, our experienced tutors provide personalised support tailored to the PMS syllabus of each province. They understand the unique challenges of the PMS examination and help aspirants develop the skills needed for success.`,
        `With a focus on building conceptual understanding and exam technique, our <a href="/tutors" class="text-[#C43D24] hover:underline font-black">online tutors</a> and <a href="/tutors" class="text-[#C43D24] hover:underline font-black">home tutors</a> provide the undivided attention that PMS preparation demands. This personalised approach is particularly effective for aspirants who need help with complex topics like provincial governance, economic development, and current affairs.`,
      ]}
      subjectDetails={[
        `Our <strong class="text-[#2E4F5E]">PMS tutors in Pakistan</strong> are subject matter experts with extensive experience in PMS preparation. Many have themselves cleared the PMS or CSS exam and understand the examination demands firsthand. They have deep knowledge of the <strong class="text-[#2E4F5E]">PMS syllabus</strong> for each province — PPSC, SPSC, BPSC, and KPKPSC.`,
        `We cover <strong class="text-[#2E4F5E]">all compulsory PMS subjects</strong> including English Essay, English Precis &amp; Composition, Pakistan Affairs, Current Affairs, General Knowledge, and Islamic Studies. We also offer tuition for <strong class="text-[#2E4F5E]">all optional subjects</strong> including Political Science, Economics, International Relations, History, Geography, Public Administration, Sociology, and more.`,
      ...
      faqs={[
        ...
        {
          q: 'Which PMS subjects do you offer tuition for?',
          a: 'We offer tuition for all compulsory PMS subjects including English Essay, English Precis & Composition, Pakistan Affairs, Current Affairs, General Knowledge, and Islamic Studies. We also offer tuition for all optional subjects including Political Science, Economics, International Relations, History, Geography, Public Administration, Sociology, Psychology, and more. If you need a specific subject not listed, <a href="https://wa.me/923095154253" target="_blank" rel="noopener noreferrer" class="text-[#C43D24] hover:underline font-black">contact us on WhatsApp</a> and we will find a tutor for you.',
        },
        {
          q: 'How much do PMS tutors in Pakistan charge?',
        ...
        {
          q: 'Do you offer online PMS tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition</a>, we also offer <a href="/tutors?subject=CSS%20%2F%20PMS" class="text-[#C43D24] hover:underline font-black">online PMS tutoring</a> for students who prefer the flexibility of learning from home or who are based outside major cities. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which cities in Pakistan do your home tutors cover?',
          a: 'Our PMS home tutors cover all major cities in Pakistan including Islamabad, Rawalpindi, Lahore, Karachi, Peshawar, Quetta, Faisalabad, Multan, Hyderabad, and many more. We also offer online PMS tutoring available worldwide. If you are in a city not listed, <a href="https://wa.me/923095154253" target="_blank" rel="noopener noreferrer" class="text-[#C43D24] hover:underline font-black">message us on WhatsApp</a> and we will confirm availability.',
        },
      ]}
      areas={PAKISTAN_AREAS}
      relatedSubjects={[
