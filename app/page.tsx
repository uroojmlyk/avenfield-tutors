...
//   description: 'Find verified online & home tutors for O Level, A Level, IGCSE, IELTS, MDCAT, CSS and 50+ subjects in Islamabad, Rawalpindi, Lahore & worldwide. Highly rated on Google. Start learning today.',
//   keywords: 'online tutors Pakistan, home tutors Pakistan, online tuition Pakistan, home tuition Pakistan, O Level tutors, A Level tutors, IGCSE tutors, IELTS tutor, MDCAT tutor, CSS tutor, Mathematics tutor, Physics tutor, Chemistry tutor, Biology tutor, English tutor, Quran tutor, home tuition Islamabad, home tuition Rawalpindi, home tuition Lahore, online tutoring worldwide, Avenfield Tutors',
//   openGraph: {
//     title: 'Online & Home Tutors in Pakistan | O Level, A Level, IELTS & MDCAT | Avenfield Tutors',
//     description: 'Find verified online & home tutors in Islamabad, Rawalpindi, Lahore & worldwide. Highly rated on Google. Expert tutors for O Level, A Level, IGCSE, IELTS, MDCAT, CSS & more.',
//     type: 'website',
//     locale: 'en_PK',
...
//     title: 'Online & Home Tutors in Pakistan | O Level, A Level, IELTS & MDCAT',
//     description: 'Find verified online & home tutors in Islamabad, Rawalpindi, Lahore & worldwide. Highly rated on Google.',
//   },
//   alternates: {
//     canonical: SITE_URL,
//   },
...
// // Sort blogs by date (newest first) for homepage display
...
//       answer: 'Finding a tutor is simple. Browse our verified tutor directory, filter by subject (O Level, A Level, IELTS, MDCAT, CSS, Mathematics, Physics, etc.), city (Islamabad, Rawalpindi, Lahore), and learning mode (online or home tuition). Review tutor profiles, qualifications, and experience, then connect directly via WhatsApp to start learning.'
//     },
//     {
//       question: 'Do you provide home tuition in Pakistan?',
//       answer: 'Yes, we provide home tuition in Islamabad, Rawalpindi, and Lahore. Our home tutors are verified and experienced in teaching O Level, A Level, IGCSE, and other curricula. We match you with qualified tutors who can visit your home for personalized lessons.'
//     },
//     {
...
//       answer: 'We provide home tuition in Islamabad, Rawalpindi, and Lahore. Our online tutoring services are available worldwide including UK, USA, Canada, Australia, and UAE.'
//     },
//     {
...
//     url: SITE_URL,
//     logo: `${SITE_URL}/avenfieldtutors-newlogo.png`,
//     description:
...
//                       const palette = [
//                         { bg: 'bg-[#E8C86A]', txt: 'text-[#2E4F5E]' },
//                         { bg: 'bg-[#3A9E8F]', txt: 'text-white' },
//                         { bg: 'bg-[#E8934A]', txt: 'text-white' },
//                       ][i % 3]
//                       const initials = t.name.split(' ').map(w => w[0]).slice(0, 2).join('')
//                       return (
//                         <Link key={t._id} href={`/tutors/${(t as any).slug || t._id}`}
//                           className="flex items-center gap-3 p-2.5 rounded-xl bg-[#FFFDF7] border-2 border-transparent hover:border-[#E8C86A] transition-all no-underline">
...
//                   </Link>
//                 </div>
//                 {/* Links to the real, live Google reviews — no hardcoded
//                     number here, since any specific count goes stale the
//                     moment a new review comes in. */}
//                 <a
...
//       )}
//          {/* ══════════════════════════════════════════════════════
//           §7  BLOG / RESOURCES — Dark Teal Background
//           (H2: Latest Guides & Exam Tips)
//       ══════════════════════════════════════════════════════ */}
//       <section
//         aria-labelledby="blog-heading"
//         className="bg-[#2E4F5E] py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 border-y-2 border-[#E8C86A]/30"
//       >
//         <div className="max-w-6xl mx-auto">
//           {/* Heading Row */}
//           <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6 sm:mb-8 md:mb-10">
//             <div>
//               <Eyebrow text="Free Resources" light />
//               <h2
//                 id="blog-heading"
//                 className="text-[1.5rem] sm:text-[2rem] md:text-[2.4rem] font-black tracking-[-0.02em] text-white"
//               >
...
//             <Link
//               href="/blog"
//               className="text-[0.8rem] font-black text-[#E8C86A] hover:text-white hover:underline flex items-center gap-1 transition-colors self-start sm:self-auto flex-shrink-0"
//               aria-label="View all blog articles and exam preparation guides"
//             >
//               View All Articles →
//             </Link>
//           </div>

//           {/* Blog Cards Grid — Golden/Yellow Cards on Dark Background */}
//           <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
//             {/* ✅ Sorted blogs: latest first, then slice first 3 */}
//             {sortedBlogPosts.slice(0, 3).map((post) => (
//               <article
//                 key={post.slug}
//                 className="group bg-[#FFFDF7] p-5 rounded-2xl border-2 border-[#2E4F5E] shadow-[4px_4px_0_0_#1a3240] hover:-translate-y-1 hover:shadow-[4px_6px_0_0_#1a3240] transition-all duration-200 flex flex-col"
//               >
//                 <Link
//                   href={`/blog/${post.slug}`}
...
//                   {/* Excerpt */}
//                   <p className="text-[0.75rem] text-[#4a6a78] font-semibold mt-2 line-clamp-2 flex-grow">
//                     {post.excerpt}
//                   </p>
                  
//                   {/* Meta Footer */}
//                   <div className="flex items-center gap-3 mt-4 pt-3 border-t border-[#2E4F5E]/20">
...
//       {/* ══════════════════════════════════════════════════════
//           §7  GOOGLE REVIEWS — real, verifiable trust signal
//           (The fabricated named testimonials that used to live here were
//           replaced: they weren't backed by real review data and risked
//           violating Google's policy on fake reviews. This links out to the
//           real, live Google Business Profile instead.)
//       ══════════════════════════════════════════════════════ */}
//       {/* <section
//         aria-labelledby="reviews-heading"
//         className="bg-[#E8934A] py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 border-y-2 border-[#2E4F5E]"
//       >
//         <div className="max-w-3xl  mx-auto text-center">
//           <Eyebrow text="Rated by Real Families" center />
...
//             ))}
//           </div>
//           <p className="text-white/80 text-[0.92rem] sm:text-[1rem] font-semibold mb-8 max-w-xl mx-auto">
//             Genuine reviews from real parents and students, verified on Google, not curated quotes.
//             See exactly what families are saying, unedited and always up to date.
//           </p> */}
//           {/* <a
//             href="https://www.google.com/search?q=avenfield+tutors"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="inline-flex items-center gap-2 px-6 py-3.5 bg-white text-[#2E4F5E] font-black text-[0.9rem] rounded-xl border-2 border-[#2E4F5E] shadow-[0_4px_0_0_#2E4F5E] hover:shadow-[0_2px_0_0_#2E4F5E] hover:translate-y-[2px] transition-all duration-150 no-underline"
//           >
...
//             ))}
//           </div>
//           <p className="text-white/90 text-[0.92rem] sm:text-[1rem] font-semibold mb-8 max-w-xl mx-auto">
//             Genuine reviews from real parents and students, verified on Google, not curated quotes.
//             See exactly what families are saying, unedited and always up to date.
//           </p>
          
//           {/* 🔥 FIXED BUTTON — Safed background, dark teal text, bilkul visible */}
//           <a
//             href="https://www.google.com/search?q=avenfield+tutors"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="inline-flex items-center gap-3 px-6 py-3.5 bg-white text-[#1a3240] font-black text-[0.9rem] rounded-xl border-2 border-[#1a3240] shadow-[0_4px_0_0_#1a3240] hover:bg-[#FFFDF7] hover:shadow-[0_2px_0_0_#1a3240] hover:translate-y-[2px] transition-all duration-150 no-underline"
//           >
...
//                 a: 'Yes, we provide home tuition in Islamabad, Rawalpindi, and Lahore. Our home tutors are verified and experienced in teaching O Level, A Level, IGCSE, and other curricula. We match you with qualified tutors who can visit your home for personalized lessons.'
//               },
//               {
...
//                 a: 'We provide home tuition in Islamabad, Rawalpindi, and Lahore. Our online tutoring services are available worldwide including UK, USA, Canada, Australia, and UAE.'
//               },
//               {
