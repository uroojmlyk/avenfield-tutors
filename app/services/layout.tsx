...
export const metadata: Metadata = {
  ...
  description: 'Find verified online and home tutoring services for O Level, A Level, IGCSE, IELTS, MDCAT, CSS and 50+ subjects in Lahore, Karachi, Islamabad & worldwide. 500+ qualified tutors. Start learning today.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Find verified online and home tutoring for O Level, A Level, IGCSE, IELTS, MDCAT, CSS and 50+ subjects. 500+ qualified tutors in Lahore, Karachi, Islamabad & worldwide.',
    type: 'website',
    locale: 'en_PK',
    siteName: 'Avenfield Tutors',
    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.avenfieldtutors.com'}/services`,
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Find verified online and home tutoring for O Level, A Level, IELTS, MDCAT, CSS and 50+ subjects. 500+ qualified tutors.',
    images: [`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.avenfieldtutors.com'}/avenfield.jpeg`],
  },
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.avenfieldtutors.com'}/services`,
  },
}
