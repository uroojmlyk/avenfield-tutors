...
export default function AccountingTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="🧾"
      subjectOverview={[
        `The <a href="/tutors?subject=Accounting&city=Islamabad" class="text-[#C43D24] hover:underline font-black">Accounting tutor in Islamabad</a> market is growing as students pursue careers in finance, business, and professional accounting qualifications. Accounting is a core subject for O Level, A Level, IGCSE, and university students, covering financial accounting, cost accounting, and management accounting. Our verified Accounting tutors in Islamabad help students develop a strong foundation in accounting principles with practical applications.`,
        `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">O Level Accounting</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">A Level Accounting</a>, <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#C43D24] hover:underline font-black">IGCSE</a>, or professional qualifications like <a href="/tutors?subject=CA&city=Islamabad" class="text-[#C43D24] hover:underline font-black">CA</a> and <a href="/tutors?subject=ACCA&city=Islamabad" class="text-[#C43D24] hover:underline font-black">ACCA</a>, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus from Cambridge CAIE and Edexcel to professional accounting bodies and help students develop strong analytical and problem-solving skills.`,
      ...
      faqs={[
        ...
        {
          q: 'Which Accounting curricula do you offer tuition for?',
          a: 'We offer tuition for all major Accounting curricula including CAIE (Cambridge International) O Level and A Level, Edexcel, Oxford AQA, IGCSE, University-level courses, and professional qualifications like CA and ACCA. Our tutors are familiar with the specific requirements of each curriculum and exam board. If you need a specific syllabus not listed, <a href="https://wa.me/923095154253" target="_blank" rel="noopener noreferrer" class="text-[#C43D24] hover:underline font-black">contact us on WhatsApp</a> and we will find a tutor for you.',
        },
        {
          q: 'How much do Accounting tutors in Islamabad charge?',
        ...
        {
          q: 'Do you offer online Accounting tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition in Islamabad</a>, we also offer <a href="/tutors?subject=Accounting" class="text-[#C43D24] hover:underline font-black">online Accounting tutoring</a> for students who prefer the flexibility of learning from home. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which areas of Islamabad do your home tutors cover?',
