...
export default function EconomicsTutorIslamabadPage() {
  return (
    <SubjectLandingPage
      ...
      subjectEmoji="🌐"
      subjectOverview={[
        `The <a href="/tutors?subject=Economics&city=Islamabad" class="text-[#C43D24] hover:underline font-black">Economics tutor in Islamabad</a> market is thriving as students seek to understand the forces that shape economies, markets, and societies. Economics is a core subject for O Level, A Level, IGCSE, and university students, covering microeconomics, macroeconomics, and international economics. Our verified Economics tutors in Islamabad help students develop a deep understanding of economic principles with real-world applications.`,
        `Whether your child is preparing for <a href="/tutors?subject=O%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">O Level Economics</a>, <a href="/tutors?subject=A%20Level&city=Islamabad" class="text-[#C43D24] hover:underline font-black">A Level Economics</a>, <a href="/tutors?subject=IGCSE&city=Islamabad" class="text-[#C43D24] hover:underline font-black">IGCSE</a>, or <a href="/tutors?subject=FSc&city=Islamabad" class="text-[#C43D24] hover:underline font-black">FSc</a> and university-level courses, our experienced tutors provide personalised support tailored to the specific curriculum. They understand the unique challenges of each exam board and syllabus from Cambridge CAIE and Edexcel to local Pakistani boards and help students develop strong analytical and essay writing skills.`,
      ...
      faqs={[
        ...
        {
          q: 'Which Economics curricula do you offer tuition for?',
          a: 'We offer tuition for all major Economics curricula including CAIE (Cambridge International) O Level and A Level, Edexcel, Oxford AQA, IGCSE, FSc (local Pakistani boards), and University-level courses. Our tutors are familiar with the specific requirements of each curriculum and exam board. If you need a specific syllabus not listed, <a href="https://wa.me/923095154253" target="_blank" rel="noopener noreferrer" class="text-[#C43D24] hover:underline font-black">contact us on WhatsApp</a> and we will find a tutor for you.',
        },
        {
          q: 'How much do Economics tutors in Islamabad charge?',
        ...
        {
          q: 'Do you offer online Economics tutoring as well?',
          a: 'Yes! While we specialise in <a href="/home-tutor-islamabad" class="text-[#C43D24] hover:underline font-black">home tuition in Islamabad</a>, we also offer <a href="/tutors?subject=Economics" class="text-[#C43D24] hover:underline font-black">online Economics tutoring</a> for students who prefer the flexibility of learning from home. Our online sessions are conducted via video call with interactive whiteboards and screen sharing, making them just as effective as in-person sessions.',
        },
        {
          q: 'Which areas of Islamabad do your home tutors cover?',
