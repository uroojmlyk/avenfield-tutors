...
//           scrolled
//             ? 'bg-[#FFFDF7]/90 backdrop-blur-md border-[#2E4F5E]/20'
//             : 'bg-[#FFFDF7] border-[#2E4F5E]/10'
//         }`}
//         style={{ fontFamily: "'Nunito', 'Fredoka One', sans-serif" }}
//       >
//         <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">

//           {/* Logo – clean, no extra badge */}
//           <Link
//             href="/"
...
//           {/* Desktop Nav – clean, bold, vibrant */}
...
//                 pathname === '/'
//                   ? 'text-[#2E4F5E] font-bold border-b-2 border-[#2E4F5E] pb-0.5'
//                   : 'text-[#2E4F5E] hover:text-[#3A9E8F]'
//               }`}
//               style={{ fontFamily: "'Nunito', sans-serif" }}
//             >
//               Home
...
//                 }`}
//               >
//                 <div className="bg-white border border-[#2E4F5E]/10 rounded-2xl shadow-xl p-3 min-w-[280px] overflow-hidden">
//                   <p className="px-3 pt-1 pb-2 text-[0.6rem] font-black uppercase tracking-[0.15em] text-[#2E4F5E]/40">
//                     Local Home Tutoring
//                   </p>
//                   <Link
//                     href="/services"
//                     className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-[#FFFDF7] transition-colors mb-1 group/item"
//                   >
//                     <span className="w-8 h-8 rounded-lg bg-[#2E4F5E] text-[#E8C86A] flex items-center justify-center text-[0.85rem] flex-shrink-0 group-hover/item:scale-110 transition-transform">✨</span>
//                     <span className="text-sm font-bold text-[#2E4F5E]">All Services</span>
//                   </Link>
//                   <div className="h-px bg-[#D4D0C5]/50 my-1.5 mx-1" />
//                   {cityLinks.map((l, i) => {
//                     const cityAccents = [
//                       { bg: 'bg-[#3A9E8F]', ring: 'group-hover/item:bg-[#3A9E8F]/10' },
//                       { bg: 'bg-[#E8934A]', ring: 'group-hover/item:bg-[#E8934A]/10' },
...
//                         key={l.href}
//                         href={l.href}
//                         className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors group/item ${cityAccents.ring}`}
//                       >
//                         <span className={`w-8 h-8 rounded-lg ${cityAccents.bg} text-white flex items-center justify-center text-[0.7rem] flex-shrink-0 group-hover/item:scale-110 transition-transform`}>📍</span>
//                         <span className="text-sm font-bold text-[#2E4F5E] whitespace-nowrap">{l.label}</span>
//                         <svg className="w-3.5 h-3.5 text-[#D4D0C5] ml-auto opacity-0 group-hover/item:opacity-100 group-hover/item:translate-x-0.5 -translate-x-1 transition-all flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
//                           <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
//                         </svg>
//                       </Link>
//                     )
...
//             <Link
//               href="/become-tutor"
//               className="inline-flex items-center gap-2 rounded-full bg-[#E05C42] text-white px-5 py-2.5 text-sm font-medium hover:opacity-90 transition-opacity"
//               style={{ fontFamily: "'Nunito', sans-serif" }}
//               aria-label="Join Avenfield Tutors as a tutor"
//             >
//               Join as Tutor ✨
...
//               className="p-2 rounded-full hover:bg-[#2E4F5E]/10 transition-colors"
//             >
//               <div className="w-5 flex flex-col gap-[5px]" aria-hidden="true">
//                 <span className={`block h-0.5 bg-[#2E4F5E] origin-center transition-all duration-300 ${open ? 'rotate-45 translate-y-[7px]' : ''}`} />
//                 <span className={`block h-0.5 bg-[#2E4F5E] transition-all duration-300 ${open ? 'opacity-0 scale-x-0' : ''}`} />
//                 <span className={`block h-0.5 bg-[#2E4F5E] origin-center transition-all duration-300 ${open ? '-rotate-45 -translate-y-[7px]' : ''}`} />
//               </div>
//             </button>
//           </div>
...
//         {/* Drawer panel */}
//         <div
//           className={`absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-[#FFFDF7] shadow-2xl transition-transform duration-300 ease-out ${
//             open ? 'translate-x-0' : 'translate-x-full'
//           }`}
//         >
//           <nav
//             className="flex flex-col gap-1.5 p-5 pt-20 h-full overflow-y-auto"
//             aria-label="Mobile navigation"
//             style={{ fontFamily: "'Nunito', sans-serif" }}
//           >
//             {navIcons.map(({ href, label, icon }, i) => (
...
//                   href={href}
//                   aria-current={pathname === href ? 'page' : undefined}
//                   className={`flex items-center gap-3 px-3 py-3 text-sm font-bold rounded-xl transition-colors ${
//                     pathname === href
//                       ? 'text-white bg-[#2E4F5E]'
//                       : 'text-[#2E4F5E] hover:bg-[#2E4F5E]/10'
//                   }`}
//                   onClick={() => setOpen(false)}
//                 >
//                   <span className={`w-9 h-9 rounded-lg flex items-center justify-center text-[1rem] flex-shrink-0 ${
//                     pathname === href ? 'bg-white/15' : 'bg-[#FFFDF7]'
//                   }`} aria-hidden="true">
//                     {icon}
//                   </span>
...
//                 {/* Services with collapsible sub-items (inside drawer) */}
//                 {i === 0 && (
//                   <div className="flex flex-col gap-1.5">
//                     <button
//                       onClick={() => setMobileServicesOpen(!mobileServicesOpen)}
...
//                       }`}
//                     >
//                       <div className="ml-3 pl-3 py-1 flex flex-col gap-1.5 border-l-2 border-dashed border-[#E8C86A]/50">
//                         <Link
//                           href="/services"
//                           className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white border border-[#D4D0C5]/50 hover:border-[#2E4F5E] transition-colors"
//                           onClick={() => setOpen(false)}
//                         >
//                           <span className="w-7 h-7 rounded-lg bg-[#2E4F5E] text-[#E8C86A] flex items-center justify-center text-[0.75rem] flex-shrink-0">✨</span>
//                           <span className="text-sm font-bold text-[#2E4F5E]">All Services</span>
...
//                                 pathname === l.href
//                                   ? 'text-white bg-[#2E4F5E] border-[#2E4F5E]'
//                                   : 'bg-white border-[#D4D0C5]/50 hover:border-[#2E4F5E] text-[#2E4F5E]'
//                               }`}
//                               onClick={() => setOpen(false)}
//                             >
//                               <span className={`w-7 h-7 rounded-lg ${accent.bg} text-white flex items-center justify-center text-[0.65rem] flex-shrink-0`}>📍</span>
//                               <span className="text-sm font-bold whitespace-nowrap">{l.label}</span>
//                             </Link>
//                           )
//                         })}
//                       </div>
...
//             <Link
//               href="/become-tutor"
//               className="mt-4 flex items-center justify-center gap-2 px-5 py-3.5 bg-[#E05C42] text-white text-sm font-bold rounded-full text-center hover:opacity-90 transition-opacity"
//               aria-label="Apply to become a tutor at Avenfield Tutors"
//               onClick={() => setOpen(false)}
//             >
//               Join as Tutor ✨
