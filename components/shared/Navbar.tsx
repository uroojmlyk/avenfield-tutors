  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-8 h-[66px] flex items-center justify-between gap-4">
        ...
        {/* ── Logo ── WITHOUT SQUARE BOX */}
        <Link
          href="/"
          className="flex items-center gap-3 flex-shrink-0 group"
          aria-label="Avenfield Tutors – Expert Online & Home Tutoring"
        >
          {/* Logo image - NO BORDER, NO SHADOW, NO SQUARE BOX */}
          <div className="relative flex-shrink-0 h-[44px] sm:h-[52px] w-auto">
            <Image
              src="/avenfield.jpeg"
          ...
          <div className="flex flex-col leading-none">
            <span
              className="text-[#2E4F5E] font-black tracking-[-0.02em] text-[1rem] sm:text-[1.2rem] leading-tight"
              style={{ fontFamily: "'Nunito', sans-serif" }}
            >
              Avenfield <span className="text-[#3A9E8F]">Tutors</span>
            </span>
          </div>
        </Link>
